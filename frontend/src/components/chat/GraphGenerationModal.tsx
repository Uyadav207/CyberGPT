...
const GraphGenerationModal: React.FC<GraphGenerationModalProps> = ({
  ...
  const [progress, setProgress] = useState(externalProgress || 0);const steps: ProgressStep[] = [
    {
      id: 'analyzing',
      title: 'Analyzing Response',
      description: 'Extracting key concepts and entities',
    ...
    },
    {
      ...
      description: 'Fetching related cybersecurity data',
      ...
      >
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Creating cybersecurity visualization
              </p>
            </div>
            ...
            {/* Current Step */}
            <div className="mb-4">
              <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
            ...
            <div className="mb-4 p-3 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-200 dark:border-blue-700">
              ...
              <p className="text-xs text-blue-600 dark:text-blue-300">
                ...
                {currentStep === 1 && "🗄️ Querying cybersecurity knowledge database"}
                {currentStep === 2 && "✨ Your personalized security graph is ready!"}
              </p>
            </div>
